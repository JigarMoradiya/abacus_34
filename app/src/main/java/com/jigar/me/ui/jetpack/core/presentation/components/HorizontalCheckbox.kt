...
fun HorizontalCheckbox(
    ...
    Row(
        ...
        horizontalArrangement = Arrangement.spacedBy(if (DeviceInfo.isTablet) AppDimens.Dimens8 else AppDimens.Dimens4)
    ) {
        Checkbox(checked = checked, onCheckedChange = null,modifier = Modifier.scale(
