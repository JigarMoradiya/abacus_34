...
class ExamResultCommonAdapter(
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        return if (data.isAbacusQuestion == true){
            0
            ...
            0 ->{ // abacus
                with(holder as ViewHolderAbacus){
                    ...
                    if (data.type == BeginnerExamQuestionType.Count){
                        ...
                        abacusBinding1.relAbacus.setPadding(0)
                        ...
                        abacusBinding1.relAbacus.layoutParams = params
                        abacusBinding1.relAbacus.setPadding(0)
                        abacusBinding2.relAbacus.setPadding(0)
    ...
    class ViewHolderTxt(itemBinding: RawExamResultBinding) :
        RecyclerView.ViewHolder(itemBinding.root) {
        var mBinding: RawExamResultBinding = itemBinding
    }
