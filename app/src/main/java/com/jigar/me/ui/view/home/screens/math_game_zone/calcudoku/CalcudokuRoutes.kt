...
@Composable
fun CalcudokuHomeRoute(
    homeActivityViewModel: HomeActivityViewModel,
    onStartPlay: (diff: String) -> Unit,
    onBackClick: () -> Unit,
) {
    val viewModel: CalcudokuHomeViewModel = hiltViewModel()
...
@Composable
fun CalcudokuPlayRoute(onBackClick: () -> Unit) {
    val viewModel: CalcudokuPlayViewModel = hiltViewModel()
    CalcudokuPlayScreen(viewModel = viewModel, onBackClick = onBackClick)
}
