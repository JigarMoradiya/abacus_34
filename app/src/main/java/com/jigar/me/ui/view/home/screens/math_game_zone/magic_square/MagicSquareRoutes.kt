...
@Composable
fun MagicSquareHomeRoute(
    homeActivityViewModel: HomeActivityViewModel,
    onStartPlay: (diff: String) -> Unit,
    onBackClick: () -> Unit,
) {
    val viewModel: MagicSquareHomeViewModel = hiltViewModel()
...
@Composable
fun MagicSquarePlayRoute(onBackClick: () -> Unit) {
    val viewModel: MagicSquarePlayViewModel = hiltViewModel()
    MagicSquarePlayScreen(viewModel = viewModel, onBackClick = onBackClick)
}
