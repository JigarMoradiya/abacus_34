...
@Composable
fun MathBingoHomeRoute(
    homeActivityViewModel: HomeActivityViewModel,
    onStartPlay: (diff: String) -> Unit,
    onBackClick: () -> Unit,
) {
    val viewModel: MathBingoHomeViewModel = hiltViewModel()
...
@Composable
fun MathBingoPlayRoute(onBackClick: () -> Unit) {
    val viewModel: MathBingoPlayViewModel = hiltViewModel()
    MathBingoPlayScreen(viewModel = viewModel, onBackClick = onBackClick)
}
