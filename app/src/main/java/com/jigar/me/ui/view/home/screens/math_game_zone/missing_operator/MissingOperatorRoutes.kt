...
@Composable
fun MissingOperatorHomeRoute(
    homeActivityViewModel: HomeActivityViewModel,
    onStartPlay: (diff: String) -> Unit,
    onBackClick: () -> Unit,
) {
    val viewModel: MissingOperatorHomeViewModel = hiltViewModel()
...
@Composable
fun MissingOperatorPlayRoute(onBackClick: () -> Unit) {
    val viewModel: MissingOperatorPlayViewModel = hiltViewModel()
    MissingOperatorPlayScreen(viewModel = viewModel, onBackClick = onBackClick)
}
