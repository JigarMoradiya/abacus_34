...
import com.jigar.me.ui.view.home.screens.math_game_zone.number_detective.components.NumberDetectiveHomeViewModel
import com.jigar.me.ui.view.home.screens.math_game_zone.number_detective.viewmodel.NumberDetectivePlayViewModel

@Composable
fun NumberDetectiveHomeRoute(
    homeActivityViewModel: HomeActivityViewModel,
    onStartPlay: (diff: String) -> Unit,
    onBackClick: () -> Unit,
) {
    val viewModel: NumberDetectiveHomeViewModel = hiltViewModel()
...
@Composable
fun NumberDetectivePlayRoute(onBackClick: () -> Unit) {
    val viewModel: NumberDetectivePlayViewModel = hiltViewModel()
    NumberDetectivePlayScreen(viewModel = viewModel, onBackClick = onBackClick)
}
