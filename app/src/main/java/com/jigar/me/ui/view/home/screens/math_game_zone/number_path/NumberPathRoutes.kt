...
@Composable
fun NumberPathHomeRoute(
    homeActivityViewModel: HomeActivityViewModel,
    onStartPlay: (diff: String, level: Int) -> Unit,
    onBackClick: () -> Unit,
) {
    val viewModel: NumberPathHomeViewModel = hiltViewModel()
...
@Composable
fun NumberPathPlayRoute(
    onBackClick: () -> Unit,
    onNextLevel: (diff: String, level: Int) -> Unit
) {
    val viewModel: NumberPathPlayViewModel = hiltViewModel()
    NumberPathPlayScreen(
        viewModel = viewModel,
        onBackClick = onBackClick,
