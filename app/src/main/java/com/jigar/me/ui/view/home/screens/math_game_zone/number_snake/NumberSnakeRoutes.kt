...
@Composable
fun NumberSnakeHomeRoute(
    homeActivityViewModel: HomeActivityViewModel,
    onStartPlay: (diff: String) -> Unit,
    onBackClick: () -> Unit,
) {
    val viewModel: NumberSnakeHomeViewModel = hiltViewModel()
...
@Composable
fun NumberSnakePlayRoute(onBackClick: () -> Unit) {
    val viewModel: NumberSnakePlayViewModel = hiltViewModel()
    NumberSnakePlayScreen(viewModel = viewModel, onBackClick = onBackClick)
}
