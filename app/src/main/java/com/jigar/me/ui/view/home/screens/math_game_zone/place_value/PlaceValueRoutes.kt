...
@Composable
fun PlaceValueHomeRoute(
    homeActivityViewModel: HomeActivityViewModel,
    onStartPlay: (diff: String) -> Unit,
    onBackClick: () -> Unit,
) {
    val viewModel: PlaceValueHomeViewModel = hiltViewModel()
...
@Composable
fun PlaceValuePlayRoute(onBackClick: () -> Unit) {
    val viewModel: PlaceValuePlayViewModel = hiltViewModel()
    PlaceValuePlayScreen(viewModel = viewModel, onBackClick = onBackClick)
}
