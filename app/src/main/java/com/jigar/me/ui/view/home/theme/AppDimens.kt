...
object AppDimens {
    ...
    val Dimens14 = if(isLargeTablet) 28.dp else if (isTablet) 20.dp else 14.dp
    ...
    val Dimens28 = if(isLargeTablet) 56.dp else if (isTablet) 42.dp else 28.dp
    val Dimens32 = if(isLargeTablet) 64.dp else if (isTablet) 48.dp else 32.dp
    val Dimens40 = if(isLargeTablet) 80.dp else if (isTablet) 60.dp else 40.dp
    val Dimens50 = if(isLargeTablet) 100.dp else if (isTablet) 75.dp else 50.dp
    val Dimens30 = if(isLargeTablet) 60.dp else if (isTablet) 45.dp else 30.dp
    val Dimens36 = if(isLargeTablet) 72.dp else if (isTablet) 54.dp else 36.dp
    val Dimens45 = if(isLargeTablet) 90.dp else if (isTablet) 70.dp else 45.dp
    val Dimens46 = if(isLargeTablet) 92.dp else if (isTablet) 62.dp else 46.dp
    val Dimens48 = if(isLargeTablet) 96.dp else if (isTablet) 76.dp else 48.dp
    val Dimens56 = if(isLargeTablet) 110.dp else if (isTablet) 80.dp else 56.dp

    val Dimens60 = if(isLargeTablet) 120.dp else if (isTablet) 90.dp else 60.dp
    ...
    val AbacusHorizontalSpace = if(isLargeTablet) 144.dp else if (isTablet) 108.dp else 72.dp
