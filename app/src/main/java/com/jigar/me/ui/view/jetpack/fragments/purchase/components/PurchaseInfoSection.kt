...
fun PurchaseInfoSection(
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.go_premium_all_levels_all_features),
        ...
        Card(
            ...
            modifier = Modifier.padding(dimensionResource(R.dimen.activity_padding12))
        ) {
            Column(modifier = Modifier.padding(dimensionResource(R.dimen.activity_padding12)),verticalArrangement = Arrangement.spacedBy(dimensionResource(R.dimen.activity_padding4))) {
                infoList.forEach {
                    Text(
                        text = it.htmlToAnnotatedString(),
                        style = MaterialTheme.typography.labelLarge.copy(fontWeight = FontWeight.Normal,fontFamily = FontFamily(Font(R.font.font_regular)))
                    )
                }
            }
        }
